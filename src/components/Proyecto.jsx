...
const Proyecto = ({ proyectos }) => {
  return (
    <>
      ...
      {/* Botón de link para los proyectos */}
      ...
      <section className="flex flex-col items-center gap-y-10">
        <div className="flex flex-col sm:flex-row w-full gap-y-5 gap-x-10 mb-8">
          <figure className="col-span-4 sm:w-1/3 ">
        ...
        <div className="flex flex-col sm:flex-row w-full gap-y-5 gap-x-10 mb-8">
          <figure className="col-span-4 sm:w-9/12">
